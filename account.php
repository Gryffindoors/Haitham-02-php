    ...
    <section class="container text-bg-secondary my-5 py-3">
        ...
        <h2>Signup</h2>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="username"
                        value="<?= isset($edit['username']) ? htmlspecialchars($edit['username']) : '' ?>" type="text"
                        class="form-control" placeholder="Required" id="username">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="password" type="password" class="form-control" placeholder="Required" id="password">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="email" type="email" class="form-control" placeholder="Required" id="emailAddress">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="phone" type="text" class="form-control" placeholder="Required" id="phoneNumber">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="facebook" type="url" class="form-control" placeholder="Optional" id="facebookProfile">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="twitter" type="url" class="form-control" placeholder="Optional" id="twitterprofile">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="instagram" type="url" class="form-control" placeholder="Optional"
                        id="instagramProfile">
                </div>
            </div>
